...
!(function (t) {
  ...
  return (function t(e, n, r) {
  ...
  })(
    {
          ...
          !(function (t) {
              ...
              return (
                ...
                (x.prototype.setConfig = function (t) {
                  (t = t || {}),
                    ...
                    (this._start = t.start || p),
                    (this._step = t.step || p),
                    (this._finish = t.finish || p),
                    (this._duration = t.duration || 500),
                    (this._currentState = t.from || this.get()),
                    (this._originalState = this.get()),
                    (this._targetState = t.to || this.get()),
                    (this._timestamp = l());
                  var e = this._currentState,
                    n = this._targetState;
                  return (
                    g(n, e),
                    (this._easing = y(e, t.easing || u)),
                    (this._filterArgs = [
                      e,
                      this._originalState,
                      n,
                ...
                (x.prototype.pause = function () {
                  return (
                    (this._pausedAtTime = l()), (this._isPaused = !0), this
                  );
                }),
                (x.prototype.resume = function () {
                  this._isPaused &&
                    (this._timestamp += l() - this._pausedAtTime),
                    (this._isPaused = !1),
                    (this._isTweening = !0);
                  var t = this;
                  return (
                ...
                (x.prototype.stop = function (t) {
                  return (
                    (this._isTweening = !1),
                    (this._isPaused = !1),
                    (this._timeoutHandler = p),
                    t &&
                      (d(this._currentState, this._targetState),
                      m(this, "afterTweenEnd"),
                ...
                "function" == typeof SHIFTY_DEBUG_NOW && (t.timeoutHandler = v),
                "object" == typeof n
                  ? (e.exports = x)
                  : void 0 === t.Tweenable && (t.Tweenable = x),
                x
              );
            })();
            r.shallowCopy(r.prototype.formula, {
              ...
              (function () {
                var t = new r();
                (t._filterArgs = []),
                  (r.interpolate = function (e, n, i, o) {
                    ...
                    (u.length = 0),
                      ...
                      (u[2] = n),
                      (u[3] = a),
                      r.applyFilter(t, "tweenCreated"),
                      r.applyFilter(t, "beforeTween");
                    var h,
                      f,
                      l,
                      p,
                ...
                t.prototype.filter.token = {
                  ...
                  afterTween: function (e, n, r, i) {
                    ...
                    w(e, this._tokenData),
                      ...
                      t.each(s, function (t) {
                        for (
                          var e = s[t].chunkNames, n = e.length, r = "", i = 0;
                          i < n;
                          i++
                        )
      ...
      4: [
        ...
        { "./circle": 2, "./line": 3, "./path": 5, "./square": 7 },
      ],
      5: [
        function (t, e, n) {
          var r = t("shifty"),
            ...
            s = function (t, e) {
              ...
              (this._path.style.strokeDasharray = n + " " + n),
                (this._path.style.strokeDashoffset = n);
            };
          (s.prototype.value = function () {
            ...
            (s.prototype.set = function (t) {
              this.stop(),
                (this._path.style.strokeDashoffset = this._progressToOffset(t));
              var e = this._opts.step;
              i.isFunction(e) &&
                e(
                  this._calculateTo(t, "linear"),
                  this._opts.attachment || this
                );
            }),
            (s.prototype.stop = function () {
              this._stopTween(),
                (this._path.style.strokeDashoffset =
            ...
            (s.prototype.animate = function (t, e, n) {
              ...
              (this._tweenable = new r()),
                this._tweenable.tween({
                  ...
                  easing: a,
                  step: function (t) {
                    (l._path.style.strokeDashoffset = t.offset),
                      e.step(t, e.attachment);
                  },
                  finish: function (t) {
                    (l._path.style.strokeDashoffset = t.offset),
                      e.step(t, e.attachment),
        ...
        function (t, e, n) {
              ...
              if (0 !== arguments.length) {
                ...
                (this._container = o),
                  ...
                  this._opts.text.value &&
                    ((this.text = this._createTextElement(
                      this._opts,
                      this._container
                    )),
          ...
          (s.prototype.animate = function (t, e, n) {
            ...
            (s.prototype.setText = function (t) {
              ...
              if (null === this.text)
                return (
                  ...
                  void this._container.appendChild(this.text)
                );
            ...
            (s.prototype._createTextElement = function (t, e) {
              ...
              return (
                n.appendChild(document.createTextNode(t.text.value)),
                t.text.autoStyle &&
                  ...
                  (n.style.padding = 0),
                  (n.style.margin = 0),
                  i.setStyle(n, "transform", "translate(-50%, -50%"),
                  t.text.color
                    ? (n.style.color = t.text.color)
  ...
  (function (t) {
      ...
      if (o.length) {
        ...
        for (
          n =
            ...
            (g = void 0),
            (_ = void 0),
            (_ = { height: a.innerHeight, width: a.innerWidth }).height ||
              (((d = s.compatMode) || !t.support.boxModel) &&
                (_ = {
          ...
          if (t.contains(u, i[e][0])) {
            ...
            if (!r || !n) return;
            p.top + f > r.top &&
            p.top < r.top + n.height &&
            p.left + l > r.left &&
            p.left < r.left + n.width
              ? c || h.data("inview", !0).trigger("inview", [!0])
              : c && h.data("inview", !1).trigger("inview", [!1]);
          }
      }
      var d, g, _;
    }
    ...
    (t.event.special.inview = {
      add: function (n) {
        o.push({ data: n, $element: t(this), element: this }),
  ...
  $(document).ready(function () {
    ...
    Array.prototype.forEach.call(t, function (e, n) {
      var r,
        i = e.getAttribute("data-progress");
      (r = $(e).hasClass("progress-line")
        ? new ProgressBar.Line(t[n], {
            strokeWidth: 5,
            easing: "easeInOut",
            trailWidth: 5,
            text: { value: "0", style: {} },
        ...
        $(e).bind("inview", function (t, n) {
          n &&
            ($(e).hasClass("active") ||
              (r.animate(i / 100), $(e).addClass("active")));
        });
    });
  });
